...
document.addEventListener("click", (event) => {
  if (event.target.classList.contains("song")) {
    ...
    const hideHeader = document.querySelector("custom-header");
    const hideFooter = document.querySelector("custom-footer");
    const hideDiscover = document.getElementById("discover")

    hideHeader.style.display = "none";
    hideFooter.style.display = "none";
    hideDiscover.style.display = "none";
...
closeBtn.addEventListener("click", () => {
  ...
  const showHeader = document.querySelector("custom-header");
  const showFooter = document.querySelector("custom-footer");
  const showDiscover = document.getElementById("discover")
